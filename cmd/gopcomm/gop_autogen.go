...
//line cmd/gopcomm/community_yap.gox:365:1
		ctx.Yap__1("user", map[string]interface{}{"Id": id, "CurrentUser": userClaim, "User": user, "Items": items, "Total": total})
	})
...
//line cmd/gopcomm/community_yap.gox:410:1
		ctx.Yap__1("user_edit", map[string]interface{}{"User": user, "CurrentUser": userClaim, "Application": appInfo, "Binds": gac.GetProviderBindStatus()})
	})
